/**
 * Title:        Moduleco<p>
 * Description:  Je suis une classe qui représente des donnees de type "long" <p>
...
public class LongDataDescriptor extends DataDescriptor {
	/**
	...
	*/
	...
	public void set() {
		if (editable == true) {
			try {
				Class[] longType = { java.lang.Long.TYPE };
				Object[] longParameter = { new Long(value)};
				java.lang.reflect.Method method;
				String modifiedName =
					name.substring(0, 1).toUpperCase() + name.substring(1);
				method =
					agent.getClass().getMethod("set" + modifiedName, longType);
				method.invoke(agent, longParameter); //Agent is changed
