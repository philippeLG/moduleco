...
public class World extends ENeighbourSmallWorld {
	...
	public static String initNeighbour = "Neighbour4";
	...
	public World(int length) {
		super(length);
		//Autorun = centralControl.getAutorun2(); // DP 20/10/2002
		//Autorun.setWorld(this);
	}
	public ZoneSelector getConnectionsStrategies() { //uniquement si
													 // RandomPairwise
