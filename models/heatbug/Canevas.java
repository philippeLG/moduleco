  ...
  */
   ...
   public class Canevas extends modulecoGUI.grapheco.Canevas
   {
      ...
      protected int state[][]; // copy of the state
   
      protected Place ag;
      protected int produceMax;
      protected int prod;
      protected int size = 1;// avoid a division by zero (a nettoyer)
      ...
      public Canevas()
      {
        // choice des couleurs associées à la révision des statégies
         setColors();
